...
namespace CykelStaden.ViewModels
{
    ...
    [DataContract]
    public class IconNamesListPageViewModel : BaseViewModel
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="IconNamesListPageViewModel"/> class.
        /// </summary>
        public IconNamesListPageViewModel()
        {
        }
        #endregion
